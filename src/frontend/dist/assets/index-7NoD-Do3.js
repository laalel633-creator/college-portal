...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Westbrook College  |  12 College Drive, Westbrook, WB1 4RT  |  +44 1234 567 890  |  info@westbrook.ac.uk" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { marginTop: 6 }, children: [
          "© ",
          year,
...
function Header() {
  ...
  function isActive(to) {
    return location2.pathname === to;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { style: { borderBottom: "2px solid #ccc", background: "#fff" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { maxWidth: 900, margin: "0 auto", padding: "0 16px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          display: "flex",
                ...
                navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    style: {
                      ...
                      borderBottom: isActive(link.to) ? "2px solid #1d4ed8" : "2px solid transparent"
                    },
                    children: link.label
                  },
                  link.to
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      ...
                      style: {
                        ...
                        borderBottom: isActive("/portal") ? "2px solid #1d4ed8" : "2px solid transparent"
                      },
                      children: "My Portal"
                    }
                  ),
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { style: { padding: "8px 16px" }, "aria-label": "Mobile navigation", children: [
          navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: link.to,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("main", { style: { flex: 1, width: "100%" }, children }),
...
const HomePage = reactExports.lazy(
  () => __vitePreload(() => import("./Home-9n6akmO0.js"), true ? [] : void 0).then((m) => ({ default: m.HomePage }))
);
const CoursesPage = reactExports.lazy(
  () => __vitePreload(() => import("./Courses-CcMkTcJW.js"), true ? [] : void 0).then((m) => ({ default: m.CoursesPage }))
);
const StaffPage = reactExports.lazy(
  () => __vitePreload(() => import("./Staff-DA5Q8180.js"), true ? [] : void 0).then((m) => ({ default: m.StaffPage }))
);
const LoginPage = reactExports.lazy(
  () => __vitePreload(() => import("./Login-C_oN1v6J.js"), true ? [] : void 0).then((m) => ({ default: m.LoginPage }))
);
const ApplyPage = reactExports.lazy(
  () => __vitePreload(() => import("./Apply-Cagt-xUT.js"), true ? [] : void 0).then((m) => ({ default: m.ApplyPage }))
);
const ContactPage = reactExports.lazy(
  () => __vitePreload(() => import("./Contact-xVX1XVBE.js"), true ? [] : void 0).then((m) => ({ default: m.ContactPage }))
);
const PortalPage = reactExports.lazy(
  () => __vitePreload(() => import("./Portal-CTuLUirg.js"), true ? [] : void 0).then((m) => ({ default: m.PortalPage }))
);
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-16 space-y-4", children: [
...
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) }) }) })
});
...
const PortalGuarded = () => /* @__PURE__ */ jsxRuntimeExports.jsx(ProtectedRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PortalPage, {}) });
